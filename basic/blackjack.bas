...
30 DIM R(15)
40 REM--P(I,J) IS THE JTH CARD IN THE HAND I, Q(K) IS THE TOTTAL OF HAND IN
...
1000 PRINT "HIT";
1010 GOTO 830
1100 REM--SUBROUTINE TO AD A CARD TO ROW I
1110 R(I)=R(I)+1
1120 P(I,R(I))=X
1130 Q=Q(I)
1140 GOSUB 500
...
1510 REM--INITIALIZE
1520 D$="N A  2  3  4  6  7N 8  9 10  J  Q K"
1530 I$="H,S,D,/,"
1540 FOR I=1 TO 13
...
1680 PRINT "FIRST RESPONSE SHOUDL BE EITHER 'D', INDICATING THAT THE"
1690 PRINT "PLAYER IS DOUBLING DOWN, 'S', INDICATING THE HE IS"
...
1720 PRINT "INITIAL RESPONSE, ALL FURTHER RESPONSES SHOUDL BE 'S' OR"
...
1750 PRINT "BLACKJACK, THE INITIAL RESPONSE SHOUDL BE 'S'."
...
2180 FOR I=1 TO N
2190 IF Z(I)<0 OR Z(I)>B(1)/2 THEN 2160
2200 NEXT I
2210 FOR I=1 TO n
